// data/countries-list.ts — 88 国签证百科元数据（COUNTRY_LIST 数据本体）
// 由 country-list.ts re-export，供 countries.ts / visa-fees.ts 等复用。
// 类型（CountryMeta / VisaTypeLabel / DifficultyLabel）在 country-list.ts 定义。
