...
export const destinations = [
  ...
  { id: 'hong-kong', name: '香港', flag: '🇭🇰', days: '3-7天', desc: '港澳通行证·购物美食迪士尼', fee: '¥80 起', difficulty: '易' as const, image: '/images/hong-kong.svg' },
  { id: 'taiwan', name: '台湾', flag: '🇨🇳', days: '5-10天', desc: '入台证·阿里山日月潭垦丁', fee: '¥90 起', difficulty: '易' as const, image: '/images/taiwan.svg' },
]
