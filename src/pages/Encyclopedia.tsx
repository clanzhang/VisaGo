    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative max-w-sm flex-1">
          <svg className="absolute left-4 top-1/2 -translate-y-1/2 text-ink/55" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
          ...
          <input
            ...
            className="w-full rounded-full border border-ink/8 bg-white py-2.5 pl-11 pr-4 text-sm shadow-card outline-none placeholder:text-ink/55 focus:border-primary/40 focus:ring-2 focus:ring-primary/10"
          />
        </div>
